...
/**
 * yarn 1.19.4: <code>net.minecraft.client.font.TextCollector</code>
 * <ul>
...
public class TextCollector {
    ...
    public IChatBaseComponent getRawCombined() {
        if (this.texts.isEmpty()) {
            ...
            IChatMutableComponent builder = texts.get(0).e();
    ...
    public IChatBaseComponent getCombined() {
        ...
        return stringVisitable != null ? stringVisitable : IChatBaseComponent.h();
    }
